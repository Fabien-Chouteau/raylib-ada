...
begin
  ...
  Music :=
   Raylib.LoadMusicStream (Resource_Path & "/S31-The Gears of Progress.ogg");
  ...
  while not Raylib.WindowShouldClose loop
    ...
    if Collision.hit then
      Raylib.DrawCube
       (Cube_Position, Cube_Size.x, Cube_Size.y, Cube_Size.z, Raylib.RED);
      Raylib.DrawCubeWires
       (Cube_Position, Cube_Size.x, Cube_Size.y, Cube_Size.z, Raylib.MAROON);
      Raylib.DrawCubeWires
       (Cube_Position,
        Cube_Size.x + 0.2,
        Cube_Size.y + 0.2,
      ...
      Raylib.DrawCube
       (Cube_Position, Cube_Size.x, Cube_Size.y, Cube_Size.z, Raylib.GRAY);
      Raylib.DrawCubeWires
       (Cube_Position, Cube_Size.x, Cube_Size.y, Cube_Size.z, Raylib.DARKGRAY);
    end if;
